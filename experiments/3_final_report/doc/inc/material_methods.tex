...
% TODO: expression screening in LB/TB/ZYM?
...
TEV-protease, and a reverse \ce{Ni^{2+}} IMAC performed, with elution with
\SI{100}{\milli\Molar} Histidine.

The eluate of the first column was concentrated to \SI{0.5}{\ml} with a
...
\SI{595}{\nm}.  Fluorescence was quenched with \SI{1}{\milli\Molar} \ce{Cu2+}
